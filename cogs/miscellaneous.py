...
class Miscellaneous(commands.Cog):
    ...
    @commands.command(
        name="random",
        brief="Generates a random number between 'start' and 'end'. Int only.",
    ...
    @commands.command(
        name="getinvite",
        brief="Invite KaeBot to your server.",
    ...
    @commands.command(
        name="rift",
        brief="Creates a rift between one channel and another.",
    ...
    @commands.command(
        name="countdown",
        brief="Start a countdown to 0 (30 seconds max).",
