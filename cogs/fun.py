...
class Fun:
    ...
    @commands.command(
        name="hotornot",
        brief="Check the hotness of someone.",
    ...
    @commands.command(
        name="lovecalculator",
        brief="Calculate the love percentage of two people.",
        description="Calculate the love percentage of two people.",
        aliases=["lovecalc"],
    )
    ...
    @commands.command(
        ...
        brief="Play a quick game of Russian Roulette.",
    ...
    @commands.command(
        name="banroulette",
        brief="Play a quick game of Ban Roulette.",
    ...
    async def banroulette(self, ctx, bullets: int = 1):
        if bullets in range(0, 7):
            if bullets == 0:
                ...
                if random.random() < (bullets / 6):
                    await ctx.send(
                        "Sorry chief, but you died! You have five seconds to say your goodbyes before you"
                        " get banned."
                    )
